...
Version  : 2.12
Release  : 20
URL      : https://pypi.debian.net/pytest-runner/pytest-runner-2.12.tar.gz
Source0  : https://pypi.debian.net/pytest-runner/pytest-runner-2.12.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1504468259
